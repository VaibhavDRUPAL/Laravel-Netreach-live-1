...
Route::get('/', 'SurveyController@home')->name('survey.home');
...
Route::get('/blog-details/{id}/{title}', 'SurveyController@blog_details2')->name('blog_details2');
...
Route::prefix('{locale}')
	...
	->group(function () {
		...
		// Route::get('/book-appoinment', 'SurveyController@bookAppoinment')->name('survey.book-appoinment');
		Route::post('/verifyMobileOTP', 'SurveyController@verify_mobile_otp')->name("verifyMobileOTP");
		Route::get('/hiv-testing/verify-number/{name?}', 'SurveyController@index')->name('hiv.letsgo');
		// Route::get('/prep-consultation/verify-number/{name?}', 'SurveyController@index')->name('letsgo');

		// Route::get('/talk-to-a-counsellor', 'SurveyController@meetCounsellorHome')->name('meetCounsellorHome');
	...
	Route::get('/set-english', function () {
...
// if (!App::isProduction()) Route::get('test', [TestController::class, 'test']);
...
Route::get('/hiv-testing/verify-number/{name?}', 'SurveyController@index')->name('hiv.servey.letsgo');
Route::get('/prep-consultation/verify-number/{name?}', 'SurveyController@index')->name('pc.servey.letsgo');
Route::get('/talk-to-a-counsellor', 'SurveyController@meetCounsellorHome')->name('talk.servey.meetCounsellorHome');
Route::post('/submit-counsellor-form', 'SurveyController@meetCounsellorFormSubmit')->name('counsellorForm.submit');
...
Route::post('/letsgo_six', 'SurveyController@letsgo_six')->name('letsgo_six');
...
// Route::get('/blog-details/{id}/{title}', 'SurveyController@blog_details')->name('blog_details');
Route::get('/faqs', 'SurveyController@faq_us')->name('faqs');
// Route::get('/privacy-policy', 'SurveyController@privacy_policy')->name('privacy-policy');
...
// Route::get('/disclaimer', 'SurveyController@disclaimer')->name('disclaimer');
Route::get('/privacy-policy', 'SurveyController@disclaimer')->name('privacy-policy');
...
Route::controller(RiskAssessmentController::class)->group(function () {
	...
	Route::get('bookAppointment', 'getBookAppointment')->name('self.book-appointment');
	Route::post('bookAppointment', 'bookAppointment');
	Route::post('prep-consultation/download-receipt', 'bookAppointment')->name("prep-consultation-download-receipt");
	Route::post('hiv-testing/download-receipt', 'bookAppointment')->name("hiv-testing-download-receipt");
...
Route::group(['middleware' => ['auth', 'log']], function () {
	...
	Route::get('/survey/e-slip-new', 'UserController@eslipNew')->name('survey.eslip.new');
	...
	Route::get('dashboard', 'HomeController@dashboard_report')->name('dashboard.report');
	...
	Route::post('/all-survey-report-slip-new', 'UserController@all_survey_report_slip_new')->name('all.survey.report.slip.new');
	...
	Route::get('/outreach/profile/listExport', 'Outreach\ProfileController@listExport')->name('outreach.profile.list.export');
	Route::get('/outreach/referral-service/listExport', 'Outreach\ReferralServiceController@listExport')->name('outreach.referral-service.list.export');
	Route::get('/outreach/plhiv/listExport', 'Outreach\PLHIVController@listExport')->name('outreach.plhiv.list.export');
	Route::name('outreach.')->group(function () {
		...
		Route::get('/outreach/delete_evidence', 'Outreach\ProfileController@delete_evidence')->name('profile.delete_evidence');
	...
	Route::group(['prefix' => 'admin/meet-counsellor', 'controller' => SurveyController::class], function () {
		Route::name('admin.meet-counsellor.')->group(function () {
			// Route::get('/', 'meetCounsellorAdmin')->name('index');
			Route::match(['get', 'post'],'/', 'meetCounsellorAdmin')->name('index');
			Route::post('/addFollowup', 'saveFollowUp')->name('saveFollowUp');
			Route::get('/followups/{id}', 'getFollowUps')->name('getFollowUps');
		});
	});
