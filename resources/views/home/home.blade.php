...
@section('content')
    ...
    <section class="landing-sec-1 first-page ">
        <img src="{{ asset('assets/img/web/home_bg.png') }}" class="main-banner">
        <div class="banner-caption">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4 text-left d-none d-sm-block " id="landing-page-bg-img">
                        <img src="{{ asset('assets/img/web/b.png') }}" class="left_img">
                    </div>
                    <div class="col-md-4 mb-3 ">
                        {{-- <div class="container"> --}}
                        <div>
                            <h1 class="heading1">{{ __('landing.title1') }} <br>
                                {{ __('landing.title2') }} 
                                <span>{{ __('landing.title3') }}</span>
                                {{-- <span style="color: #1475A1;">{{ __('landing.title3') }}</span> --}}
                            </h1>

                            <!-- button start -->
                                <div class="landing_page_btn mt-5 d-flex flex-column   justify-content-center">
                                    <button class="meetbtn w-100" id="hiv">
                                        HIV {{ __('landing.testing') }}
                                    </button>
                                    <button class="meetbtn w-100" id="prep">
                                        PrEP {{ __('landing.consultation') }}
                                    </button>
                                    <button class="meetbtn w-100" id="meet">
                                        {{ __('landing.Talk_to_a_Counsellor') }}
                                    </button>
                                    <div class="check_box mt-2 mt-md-0">
                                        <p class="checkbox_text " id="class_val"><input type="checkbox" id="disclaimer"
                                                ...
                                                style="font-size:x-small;">&nbsp;{{ __('landing.disclaimer_text1') }}<br>&nbsp;{{ __('landing.disclaimer_text2') }}<a
                                                    href="{{ url('index') }}" class="right1">&nbsp;
                                                    {{ __('landing.disclaimer_text3') }}</a></label>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div id="landing-page-pointers">
                                <div class="text_area">
                                    <h4 class="title_h4">{{ __('landing.appointment_title') }}</h4>
                                    <ul>
                                        <li><i class="fa-solid fa-circle fa-2xs" style="color: #117bdf;"></i>
                                            {{ __('landing.hiv_sti_testing') }}</li>
                                        <li><i class="fa-solid fa-circle fa-2xs" style="color: #117bdf;"></i>
                                            {{ __('landing.govt_center') }}</li>
                                        <li><i class="fa-solid fa-circle fa-2xs" style="color: #117bdf;"></i>
                                            {{ __('landing.private_healthcare') }}</li>
                                    </ul>
                                    <h4 class="title_h4"> {{ __('landing.talk_to_counsellors') }}</h4>
                                    <ul>
                                        <li><i class="fa-solid fa-circle fa-2xs" style="color: #117bdf;"></i>
                                            {{ __('landing.sexual_health_issues') }}</li>
                                        <li><i class="fa-solid fa-circle fa-2xs" style="color: #117bdf;"></i>
                                            {{ __('landing.advise_testing_treatment') }}</li>
                                        <li><i class="fa-solid fa-circle fa-2xs" style="color: #117bdf;"></i>
                                            {{ __('landing.mental_health_support') }}</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 text-center">
                        {{-- <div class="fb-page" data-href="https://www.youtube.com/@netreachofficial" data-tabs="timeline" data-width="" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                        <blockquote cite="https://www.youtube.com/@netreachofficial" class="fb-xfbml-parse-ignore"><a href="https://www.youtube.com/@netreachofficial">Netreach</a></blockquote>
                    </div> --}}
