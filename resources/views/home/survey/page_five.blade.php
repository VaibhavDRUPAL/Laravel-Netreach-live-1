        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 mb-5">
                    {{ Form::open(array('url' => '/letsgo_six')) }}
                            ...
                            <div class="card border-0 mb-2">
                                <label for="gend1" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <input type="checkbox" onclick="uncheck_chbox_other()" id="gend1" name="hivinfection[]" value="1" {{in_array("1",$hivinfectionArr) ? 'checked' : '' }}>
                        ...
                        <div class=" col-12 col-md-10">
                            <div class="card border-0 mb-2">
                                <label for="gend2" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <input type="checkbox" onclick="uncheck_chbox_other()" id="gend2" name="hivinfection[]" value="2" {{in_array("2",$hivinfectionArr) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 col-md-10">
                            <div class="card border-0 mb-2">
                                <label for="gend3" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <input type="checkbox" onclick="uncheck_chbox_other()" id="gend3" name="hivinfection[]" value="3" {{in_array("3",$hivinfectionArr) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 col-md-10">
                            <div class="card border-0 mb-2">
                                <label for="gend4" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <input type="checkbox" onclick="uncheck_chbox_other()" id="gend4" name="hivinfection[]" value="4" {{in_array("4",$hivinfectionArr) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 col-md-10">
                            <div class="card border-0 mb-2">
                                <label for="gend5" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <input type="checkbox" onclick="uncheck_chbox_other()" id="gend5" name="hivinfection[]" value="5" {{in_array("5",$hivinfectionArr) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 col-md-10">
                            <div class="card border-0 mb-2">
                                <label for="gend6" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <input type="checkbox" onclick="uncheck_chbox_other()" id="gend6" name="hivinfection[]" value="6" {{in_array("6",$hivinfectionArr) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 col-md-10">
                            <div class="card border-0 mb-2">
                                <label for="gend7" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <input type="checkbox" id="gend7" onclick="uncheck_chbox()" name="hivinfection[]" value="8" {{in_array("8",$hivinfectionArr) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 text-center">
                    <img src="{{asset('assets/img/web/fift_right.png')}}" style="width:80%;">
