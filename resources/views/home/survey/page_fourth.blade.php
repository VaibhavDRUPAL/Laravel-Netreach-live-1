        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 mb-5">
                    {{ Form::open(array('url' => '/letsgo_five')) }}
                            ...
                            <div class="card border-0 mb-2">
                                <label for="gendm" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <p class="checkbox-page"><input id="gendm" onclick="uncheck_chbox_other()" type="checkbox" name="sexually[]" value="Male" {{in_array("Male",$sexuallyArr) ? 'checked' : '' }}>&nbsp; &nbsp;
                        ...
                        <div class="col-12 col-md-8">
                            <div class="card border-0 mb-2">
                                <label for="gendf" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <p class="checkbox-page"><input type="checkbox" id="gendf" onclick="uncheck_chbox_other()" name="sexually[]" value="Female" {{in_array("Female",$sexuallyArr) ? 'checked' : '' }}>&nbsp; &nbsp;
                        ...
                        <div class="col-12 col-md-8">
                            <div class="card border-0 mb-2">
                                <label for="gendt" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <p class="checkbox-page"><input id="gendt" onclick="uncheck_chbox_other()" type="checkbox" name="sexually[]" value="Transgender" {{in_array("Transgender",$sexuallyArr) ? 'checked' : '' }}>&nbsp;&nbsp;
                        ...
                        <div class="col-12 col-md-8">
                            <div class="card border-0 mb-2">
                                <label for="other" class="mb-0">
                                    <div class="card-body bgcard py-2">
                                        <p class="checkbox-page"><input id="other" onclick="return identify_cust(this.value);" type="checkbox" name="sexually[]" value="Others" {{in_array("Other",$sexuallyArr) ? 'checked' : '' }}>&nbsp;&nbsp;
                ...
                <div class="col-md-6 text-center mt-2">
                    <img src="{{asset('assets/img/web/four_right.png')}}" width="70%">
                </div>
            </div>
            <!--row-->
