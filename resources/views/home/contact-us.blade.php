        ...
        <div class="container mt-4 mb-4">
            <div class="row">
                ...
                <div class="col-md-5 text-center">
                    <h1 class="heading1"><a href="{{ URL::to('/our-team/') }}" style="color:black !important;">{{__('contact.contactus')}} </a></h1>
                    <div class="p-4">
                        <h5>{{__('contact.collaboration')}} </h5>
                        {{-- <span> --}}
                            <p class="email-text" style="text-align: center;"><b>{{__('contact.email')}}
                                <a href="mailto:info.netreach@humsafar.org" style="color:black !important;"> info.netreach@humsafar.org</a></b></p>


                            <div class="container mt-5">
                                <h5 class="text-center mb-4 collaboration-text"><b> {{__('contact.social')}}</b></h5>
                                <div class="row align-items-center justify-content-center">
                                    <div class="social-icons">
                                        <a href="https://youtube.com/@netreachofficial/" target="_blank">
                                            <img src="{{asset('assets/img/web/youtube2.png')}}">
                                        </a>
                                        <a href="https://www.instagram.com/netreachofficial/" target="_blank">
                                            <img src="{{asset('assets/img/web/insta3.png')}}">
                                        </a>
                                        <a href="https://m.facebook.com/NETREACHofficial/" target="_blank">
                                            <img src="{{asset('assets/img/web/fb2.png')}}">
                                        </a>
                                    </div>
                                </div>
                            </div>
