							 ...
							 <div class="row">
								...
								<div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('region', array("east"=>'East',"west"=>'West',"north"=>'North',"south"=>'South'), $vns_results->region, [ 'class'=> 'form-control', 'placeholder' => 'Select Region...']) }}
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
									   ...
									   @foreach($state as $key=>$val)
										<div class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input" id="{{$key}}" name="state[]" value="{{$key}}" {{ in_array($key, $stateArr)? 'checked' : '' }}>
