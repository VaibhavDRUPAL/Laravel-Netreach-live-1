                ...
                <div class="check_box mt-2 mt-md-0">
                    <p class="checkbox_text mt-2" id="class_val"><input type="checkbox" id="disclaimer" name="disclaimer"
                        ...
                        <label class="align-top mt-1" for="disclaimer"
                            style="font-size:x-small; color: red;">&nbsp;{{ __('sra.test22') }}&nbsp;{{ __('sra.test24') }}<a
                                href="{{ url('index') }}" class="right1">&nbsp;{{ __('sra.test26') }}</a></label>
                    </p>
                </div>
            </div>

            <div class="col-12 col-sm-6 pt-3 text-end">
                <img src="{{ asset('assets/img/web/netreach-mobile.png') }}" class="widthing" class="img-fluid">
            </div>
        </div>
    </div>
    <script>
