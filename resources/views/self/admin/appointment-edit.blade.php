...
@push('pg_btn')
    <a href="{{ route('admin.self-risk-assessment.appointment') }}" class="btn btn-sm btn-neutral">All Appointments</a>
@endpush
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-5 main-form-card">
                <div class="card-body">
                    <form action="{{ route('admin.self-risk-assessment.appointment.update') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="appointment_id" id="appointment_id"
                            value="{{ $appointment[Appointments::appointment_id] }}">
                        <div class="pl-lg-4">
                            <div @class([
                                'row',
                                'd-none' =>
                            ...
                            <div @class([
                                ...
                                {{-- <div class="col-lg-4">
                                    <div class="form-group  d-flex">
                                        <label for="evidence" class='form-control-label'>Evidence</label>
                                        <input type="file" class="form-control" accept=".jpg,.jpeg,.png,.pdf"
                                            name="evidence_path[]" id="evidence" multiple onchange="checkFile()">
                                        <i class="fas fa-eye"></i>
                                        <i class="fas fa-trash"></i>
                                        <button id="resetButton" style="display:none;" onclick="resetFileInput()"
                                            class="btn btn-danger" type="button">Clear Evidence</button>
                                    </div>
                                </div> --}}
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    @if (isset($appointment[Appointments::evidence_path]))
                                                        <div class="actions_evidence d-flex my-4">
                                                            <a href="{{ asset('storage/' .$appointment[Appointments::evidence_path]) }}"
                                                                target="_blank" class="btn btn-info" role="button">
                                                                <i class="fas fa-eye"></i></a>
                                                            <button class="btn btn-danger delete_evidence"
                                                                data-id="{{ $appointment[Appointments::appointment_id] }}"
                                                                data-evidence="{{ Appointments::evidence_path }}"
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    @if (isset($appointment[Appointments::evidence_path_2]))
                                                        <div class="actions_evidence d-flex my-4">
                                                            <a href="{{ asset('storage/' . $appointment[Appointments::evidence_path_2]) }}"
                                                                target="_blank" class="btn btn-info" role="button">
                                                                <i class="fas fa-eye"></i></a>
                                                            <button class="btn btn-danger delete_evidence"
                                                                data-id="{{ $appointment[Appointments::appointment_id] }}"
                                                                data-evidence="{{ Appointments::evidence_path_2 }}"
                                                                type="button"> <i class="fas fa-trash"></i></button>
                                                        </div>
                                                    @endif
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    @if (isset($appointment[Appointments::evidence_path_3]))
                                                        <div class="actions_evidence d-flex my-4">
                                                            <a href="{{ asset('storage/' . $appointment[Appointments::evidence_path_3]) }}"
                                                                target="_blank" class="btn btn-info" role="button">
                                                                <i class="fas fa-eye"></i></a>
                                                            <button class="btn btn-danger delete_evidence"
                                                                data-id="{{ $appointment[Appointments::appointment_id] }}"
                                                                data-evidence="{{ Appointments::evidence_path_3 }}"
                                                                type="button"> <i class="fas fa-trash"></i></button>
                                                        </div>
                                                    @endif
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    @if (isset($appointment[Appointments::evidence_path_4]))
                                                        <div class="actions_evidence d-flex my-4">
                                                            <a href="" target="_blank" class="btn btn-info"
                                                                role="button">
                                                                <i class="fas fa-eye"></i></a>
                                                            <button class="btn btn-danger delete_evidence"
                                                                data-id="{{ asset('storage/' . $appointment[Appointments::appointment_id]) }}"
                                                                data-evidence="{{ Appointments::evidence_path_4 }}"
                                                                type="button">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    @if (isset($appointment[Appointments::evidence_path_5]))
                                                        <div class="actions_evidence d-flex my-4">
                                                            <a href="{{ asset('storage/' . $appointment[Appointments::evidence_path_5]) }}"
                                                                target="_blank" class="btn btn-info" role="button">
                                                                <i class="fas fa-eye"></i></a>
                                                            <button class="btn btn-danger delete_evidence"
                                                                data-id="{{ $appointment[Appointments::appointment_id] }}"
                                                                data-evidence="{{ Appointments::evidence_path_5 }}"
                                                                type="button">
                                                                <i class="fas fa-trash"></i></button>
                                                        </div>
                                                    @endif
                                ...
                                <div @class([
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="not_access_the_service_referred"
                                                ...
                                                @foreach ($REASON_FOR_NOT_ACCESSING as $key => $item)
                                                    <option value="{{ $key }}" @selected($appointment[Appointments::not_access_the_service_referred] == $key)>
                                                        {{ $item }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            {{ Form::date('date_of_accessing_service', !empty($appointment[Appointments::date_of_accessing_service]) ? $appointment[Appointments::date_of_accessing_service] : null, ['class' => 'form-control']) }}
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            {{ Form::label('pid_provided_at_the_service_center', 'PID or other unique ID of the client provided at the service centre', ['class' => 'form-control-label']) }}
                                            {{ Form::text('pid_provided_at_the_service_center', !empty($appointment[Appointments::pid_provided_at_the_service_center]) ? $appointment[Appointments::pid_provided_at_the_service_center] : null, ['class' => 'form-control']) }}
                                        </div>
                                    </div>
                                    <div class="col-lg-4" id="div_type_of_test">
                                        <div class="form-group">
                                            ...
                                            <select name="type_of_test" id="type_of_test" class="form-control">
                                                ...
                                                <option value="1" @selected(isset($appointment) && 1 == $appointment?->type_of_test)>Screening</option>
                                                <option value="2" @selected(isset($appointment) && 2 == $appointment?->type_of_test)>Confirmatory Test
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="pl-lg-4">
                                <h3 id="div_center_title" @class(['d-none' => empty($appointment[Appointments::evidence_path])])>If referred from a different service
                                    center</h3>
                                <div @class([
                                    'row',
                                    'd-none' => empty($appointment[Appointments::evidence_path]),
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="treated_state_id" id="treated_state_id" class="form-control"
                                                ...
                                                @foreach ($states as $key => $item)
                                                    <option value="{{ $key }}" @selected(isset($appointment) && $key == $appointment?->treated_state_id)>
                                                        {{ $item }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div @class([
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('pre_art_no', !empty($appointment[Appointments::pre_art_no]) ? $appointment[Appointments::pre_art_no] : null, ['class' => 'form-control']) }}
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            {{ Form::label('on_art_no', 'On ART No', ['class' => 'form-control-label']) }}
                                            {{ Form::text('on_art_no', !empty($appointment[Appointments::on_art_no]) ? $appointment[Appointments::on_art_no] : null, ['class' => 'form-control']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="pl-lg-4">
                                <div @class([
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="outcome_of_the_service_sought" class="selectpicker form-control"
                                                ...
                                                @foreach ($OUTCOME as $key => $item)
                                                    <option value="{{ $key }}" @selected($appointment[Appointments::outcome_of_the_service_sought] == $key || (empty($appointment[Appointments::outcome_of_the_service_sought]) && $loop->last))>
                                                        {{ $item }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            {{ Form::label('remark', 'Remark', ['class' => 'form-control-label']) }}
                                            {{ Form::text('remark', !empty($appointment[Appointments::remark]) ? $appointment[Appointments::remark] : null, ['class' => 'form-control']) }}
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        {{ Form::submit('Update', ['class' => 'mt-5 btn btn-primary']) }}
                                    </div>
                                </div>
                            </div>
                    </form>
