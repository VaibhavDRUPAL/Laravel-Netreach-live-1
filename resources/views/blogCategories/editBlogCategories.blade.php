                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                {{ Form::text('blog_category_name', $blog_categories->blog_category_name, ['class' => 'form-control']) }}
                            </div>

                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="status" value="1" class="custom-control-input" id="status" @checked($blog_categories->status)>
