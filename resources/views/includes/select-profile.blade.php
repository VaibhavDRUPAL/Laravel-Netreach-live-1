        ...
        <div class="pl-lg-4 select-profile mb-3">
            ...
            <div class="row">
                <div class="col-lg-6 text-left">
                    <a href="{{ route('outreach.profile.create') }}" class="btn btn-sm btn-neutral">Create New Profile</a>
                </div>
                <div class="col-lg-6 text-right">
                    {{ Form::text('search-profile', '', ['class' => 'form-control form-control-sm', 'placeholder' => 'Search profiles', 'id'=>'search-profile']) }}
    ...
    <script>
        ...
        jQuery(document).ready(function(){
            ...
            $('#search-profile').on('input',(e)=>{
                ...
                $.ajax({
                    url: "{{ route('outreach.profile.search') }}",
                    type: 'GET',
                    data: {
                        q: val,
                    },
