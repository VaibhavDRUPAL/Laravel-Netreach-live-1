@extends('layouts.app')
@push('pg_btn')
<a href="{{route('web-center-appointments')}}" class="btn btn-sm btn-neutral">All Appointments</a>
@endpush
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card mb-5 main-form-card">
            <div class="card-body">
                @if(isset($appointment))
                    {{ Form::model($appointment, ['route' => ['web-center-appointments.update', $appointment], 'method' => 'put']) }}
                @else
                    {{ Form::open(['route' => 'web-center-appointments.store']) }}
                @endif
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="client_type_id" id="client_type_id" class="selectpicker form-control" aria-placeholder="Select Client Type..." required>
                                    @foreach ($CLIENT_TYPE as $item)
                                        <option value="{{ $item?->client_type_id }}" @selected((isset($exists) && $exists == $item?->client_type_id) || (isset($appointment) && $item?->client_type_id == $appointment?->client_type_id))>{{ $item?->client_type }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="pl-lg-4">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="service_type_id" id="service_type_id" class="selectpicker form-control" aria-placeholder="Select Type of service..." required>
                                    @foreach ($TYPE_SERVICE as $item)
                                        <option value="{{ $item?->service_type_id }}" @selected(isset($appointment) && $item?->service_type_id == $appointment?->service_type_id)>{{ $item?->service_type }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('other_ti_services', 'If others (specify)', ['class' => 'form-control-label']) }}
                                {{ Form::text('other_ti_services', null, ['class' => 'form-control']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row d-none" id="div_referred_for_ti_service">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="ti_service_id" id="ti_service_id" class="selectpicker form-control" aria-placeholder="Select TI service..." required>
                                    @foreach ($REFERRED_FOR_TI_SERVICE as $item)
                                        <option value="{{ $item?->ti_service_id }}" @selected(isset($appointment) && $item?->ti_service_id == $appointment?->ti_service_id)>{{ $item?->ti_service }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('other_referred_service', 'If others (specify)', ['class' => 'form-control-label']) }}
                                {{ Form::text('other_referred_service', null, ['class' => 'form-control']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row d-none" id="div_applicable_for_hiv_test">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('applicable_for_hiv_test', 'Type of test (applicable for HIV test)', ['class' => 'form-control-label']) }}
                                {{ Form::select('applicable_for_hiv_test', $TYPE_HIV_TEST, null, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select choice...']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row d-none" id="div_applicable_for_sti_service">
                            ...
                            <div class="form-group">
                                ...
                                <select name="sti_service_id" id="sti_service_id" class="selectpicker form-control" aria-placeholder="Select Type of STI service..." required>
                                    @foreach ($TYPE_STI_SERVICE as $item)
                                        <option value="{{ $item?->sti_service_id }}" @selected(isset($appointment) && $item?->sti_service_id == $appointment?->sti_service_id)>{{ $item?->sti_service }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                {{ Form::text('other_sti_service', null, ['class' => 'form-control']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('counselling_service', 'If referred for counselling service', ['class' => 'form-control-label']) }}
                                {{ Form::select('counselling_service', $CHOICES, null, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select choice...', 'required'=>true]) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('prevention_programme', 'Ever had a HIV test as part of any Targeted Intervention programme or other HIV prevention programme?', ['class' => 'form-control-label']) }}
                                {{ Form::select('prevention_programme', $PREVENTION_PROGRAMME, null, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select choice...', 'required'=>true]) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="educational_attainment_id" id="educational_attainment_id" class="selectpicker form-control" aria-placeholder="Select Education attained..." required>
                                    @foreach ($EDUCATION as $item)
                                        <option value="{{ $item?->educational_attainment_id }}" @selected(isset($appointment) && $item?->educational_attainment_id == $appointment?->educational_attainment_id)>{{ $item?->educational_attainment }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="occupation_id" id="occupation_id" class="selectpicker form-control" aria-placeholder="Select Primary occupation..." required>
                                    @foreach ($OCCUPATION as $item)
                                        <option value="{{ $item?->occupation_id }}" @selected(isset($appointment) && $item?->occupation_id == $appointment?->occupation_id)>{{ $item?->occupation }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('other', 'Others (specify)', ['class' => 'form-control-label']) }}
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input access_service" name="access_service" value="1" id="access_service_yes" @checked(isset($appointment) && $appointment->access_service == 1)>
                                    <label class="form-check-label" for="access_service_yes">
                                        Yes
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input access_service" name="access_service" value="0" id="access_service_no" @checked(isset($appointment) && $appointment->access_service == 0)>
                                    <label class="form-check-label" for="access_service_no">
                                        No
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input access_service" name="access_service" value="2" id="access_service_scheduled" @checked(!isset($appointment) || (isset($appointment) && $appointment->access_service == 2))>
                ...
                {{-- Testing information --}}
                {{-- <hr class="my-4 d-none" id="hr_testing_information" />
                <div class="pl-lg-4 d-none" id="div_testing_information">
                    <h6 class="heading-small text-muted mb-4">Testing information</h6>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label">Where did the client access service?</label>
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input client_access_service" name="client_access_service" value="1" id="same_as_referred" @checked(!isset($appointment) || (isset($appointment) && $appointment->client_access_service == 1))>
                                    <label class="form-check-label" for="same_as_referred">
                                        Same as referred
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input client_access_service" name="client_access_service" value="0" id="other_center" @checked(isset($appointment) && $appointment->client_access_service == 0)>
                                    <label class="form-check-label" for="other_center">
                                        Other Center
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="d-none" id="div_testing_information_fields">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('type_of_facility_where_tested', 'Type of facility where tested', ['class' => 'form-control-label']) }}
                                    {{ Form::select('type_of_facility_where_tested', $TYPE_FACILITY, null, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select type...']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('test_centre_state_id', 'Test centre state', ['class' => 'form-control-label']) }}
                                    {{ Form::select('test_centre_state_id', $states, null, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select state...', 'data-state' => isset($appointment) ? $appointment['state_id'] : '']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('test_centre_district_id', 'Test centre district', ['class' => 'form-control-label']) }}
                                    {{ Form::select('test_centre_district_id', [], null, [ 'class'=> 'form-control', 'placeholder' => 'Select choice...', 'disabled' => true]) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('service_accessed_center_id', 'Name and address where service was accessed', ['class' => 'form-control-label']) }}
                                    {{ Form::select('service_accessed_center_id', [], null, ['class' => 'form-control', 'disabled' => true]) }}
                                </div>
                            </div>
                        </div>
                    </div>
                </div> --}}
                {{-- PID/other unique ID and service outcome --}}
                       ...
                       <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="reason_id" id="reason_id" class="selectpicker form-control" aria-placeholder="Select Reason for not accessing the service..." required>
                                    @foreach ($REASON_FOR_NOT_ACCESSING as $item)
                                        <option value="{{ $item?->reason_id }}" @selected(isset($appointment) && $item?->reason_id == $appointment?->reason_id)>{{ $item?->reason }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row d-none" id="div_outcome_of_the_service_sought">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                {{ Form::select('outcome_of_the_service_sought', $OUTCOME, null, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select choice...']) }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="pl-lg-4">
                    @if (isset($appointment) && isset($canTakeAction) && $canTakeAction)
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('status', 'Take action', ['class' => 'form-control-label']) }}
                                    {{ Form::select('status', [2 => 'Accept', 3 => 'Reject'], null, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select choice...']) }}
                                </div>
                            </div>
                        </div>
                    @endif
