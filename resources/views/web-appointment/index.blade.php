                    ...
                    <div class="card-header bg-transparent">
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <a href="{{ route('outreach.download') }}" class="btn btn-sm btn-info mb-0" role="button">Download Sample Sheet</a> --}}
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group mb-0">
                                    {{ Form::text('search', request()->query('search'), ['class' => 'form-control form-control-sm', 'placeholder' => 'Search by Name', 'id' => 'search']) }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            function refreshTable(search = '') {
                ...
                $(document).ready(function() {
                    ...
                    var dataTableObj = $('#survy_data_tbl_id').dataTable({
                        ...
                        "ajax": {
                            "url": "{{ route('web-center-appointments.list') }}",
                            "type": "POST",
                            "data": {
