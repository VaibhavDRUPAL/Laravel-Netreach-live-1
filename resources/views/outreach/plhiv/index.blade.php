    ...
    @section('content')
        <div class="row">
            <div class="col-md-12 my-2">
                <a href="{{ route('outreach.plhiv.list.export') }}" class="btn btn-primary  w-2 m-2 text-white"
                                ...
                                <table class="table table-hover align-items-center" id="survy_data_tbl_id">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            {{-- <th scope="col">Date of confirmatory test</th> --}}

                                            {{-- <th scope="col">Date of ART Registration</th>
                                            <th scope="col">Pre-ART Registration Number</th>
                                            <th scope="col">Date of ON ART</th>
                                            <th scope="col">ON ART Registratio Number</th> --}}

                                            {{-- <th scope="col">Type of facility where treatment was sought</th> --}}

                                            {{-- <th scope="col">ART Centre Name</th>
                                            <th scope="col">Art Centre District</th>
                                            <th scope="col">ART Centre State</th> --}}
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ url('/Importplhiv') }}" enctype="multipart/form-data"> @csrf
