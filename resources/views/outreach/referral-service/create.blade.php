...
@endphp
@push('pg_btn')
    <a href="{{ route('outreach.referral-service.index') }}" class="btn btn-sm btn-neutral">All Referral Services</a>
@endpush
@section('content')
    {{-- @dd($referral_service); --}}
    {{-- @dd($unique_serial_number[ReferralService::evidence_path]); --}}
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-5 main-form-card">
                <div class="card-body">
                    @if (isset($referral_service))
                        {{ Form::model($referral_service, ['route' => ['outreach.referral-service.update', $referral_service], 'method' => 'put', 'files' => true]) }}
                    @else
                        {{ Form::open(['route' => 'outreach.referral-service.store', 'files' => true]) }}
                    @endif
                    <div class="pl-lg-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('profile_name', $profile['profile_name'], ['class' => 'form-control', 'readonly' => true]) }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('client_name', 'Client Name', ['class' => 'form-control-label']) }}
                                    {{ Form::text('client_name', isset($referral_service['client_name']) ? $referral_service['client_name'] : null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('age_client', 'Age', ['class' => 'form-control-label']) }}
                                    {{ Form::text('age_client', isset($referral_service['age_client']) ? $referral_service['age_client'] : null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="pl-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="target_id" id="target_id" class="form-control" required>
                                        ...
                                        @foreach ($TARGET_POPULATION as $item)
                                            <option value="{{ $item?->target_id }}" @selected((isset($referral_service) && $item?->target_id == $referral_service?->target_id) || old('target_id') == $item?->target_id)>
                                                {{ $item?->target_type }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('others_target_population', 'Target population if other', ['class' => 'form-control-label']) }}
                                    {{ Form::text('others_target_population', old('others_target_population'), ['class' => 'form-control']) }}
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="service_type_id" id="service_type_id" class="form-control" required>
                                        ...
                                        @foreach ($TYPE_SERVICE as $item)
                                            <option value="{{ $item?->service_type_id }}" @selected((isset($referral_service) && $item?->service_type_id == $referral_service?->service_type_id) || old('service_type_id') == $item?->service_type_id)>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('other_service_type', 'Type of Service if Other', ['class' => 'form-control-label']) }}
                                    {{ Form::text('other_service_type', old('other_service_type'), ['class' => 'form-control']) }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('date_of_accessing_service', 'Date of referral', ['class' => 'form-control-label']) }}
                                    {{ Form::date('referral_date', null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('referred_state_id', $states, null, ['class' => 'form-control', 'placeholder' => '--- Select State ---', 'required' => true]) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('referred_district_id', [], null, ['class' => 'form-control', 'placeholder' => '--- Select District ---', 'required' => true, 'disabled' => true, 'data-id' => isset($referral_service) ? $referral_service?->referred_district_id : old('referred_district_id')]) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('referral_center_id', 'Name and address of referral centre', ['class' => 'form-control-label']) }}
                                    {{ Form::select('referral_center_id', [], null, ['class' => 'form-control', 'required' => true, 'disabled' => true, 'data-id' => isset($referral_service) ? $referral_service?->referral_center_id : old('referral_center_id')]) }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- <div class="pl-lg-4" id="div_pid_other_unique_id_and_service_outcome">
                        <h6 @class([
                            ...
                            'd-none' =>
                                (isset($referral_service) && $referral_service?->access_service == 2) ||
                                (!is_null(old('access_service')) && old('access_service') == 2),
                        ]) id="title_pid_other_unique_id_and_service_outcome">PID/other
                            unique ID and service outcome</h6>


                        <div @class([
                            'row',
                            'd-none' =>
                                (isset($referral_service) && $referral_service?->access_service != 1) ||
                                (!is_null(old('access_service')) && old('access_service') != 1),
                        ])
                            id="div_pid_or_other_unique_id_of_the_client_provided_at_the_service_cen">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('pid_or_other_unique_id_of_the_service_center', null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('outcome_of_the_service_sought', 'Outcome of the service sought', ['class' => 'form-control-label']) }}
                                    {{ Form::select('outcome_of_the_service_sought', $OUTCOME, null, ['class' => 'form-control', 'placeholder' => '--- Select Choice ---']) }}
                                </div>
                            </div>
                        </div>
                    </div> --}}

                    {{-- ------------------------Do you have Evidence section ------------------ --}}
                    <div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select name="do_you_have_evidence" class="selectpicker form-control"
                                    ...
                                    <option value="Yes"
                                        {{ isset($referral_service) && !empty($referral_service['pid_or_other_unique_id_of_the_service_center']) ? 'selected' : '' }}>
                                        Yes</option>
                                    <option value="No"
                                        {{ isset($referral_service) && empty($referral_service['pid_or_other_unique_id_of_the_service_center']) ? 'selected' : '' }}>
                                        No</option>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            @if (isset($referral_service['evidence_path']))
                                                <div class="actions_evidence d-flex my-4">

                                                    <a href="{{ asset('storage/' . $referral_service['evidence_path']) }}"
                                                        target="_blank" class="btn btn-info" role="button">
                                                        <i class="fas fa-eye"></i></a>
                                                    <button class="btn btn-danger delete_evidence_for_referral"
                                                        data-id="{{ $referral_service['referral_service_id'] }}"
                                                        data-evidence="{{ ReferralService::evidence_path }}"
                                                        type="button">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            @if (isset($referral_service['evidence_path_2']))
                                                <div class="actions_evidence d-flex my-4">
                                                    <a href="{{ asset('storage/' . $referral_service['evidence_path_2']) }}"
                                                        target="_blank" class="btn btn-info" role="button">
                                                        <i class="fas fa-eye"></i></a>
                                                    <button class="btn btn-danger delete_evidence_for_referral"
                                                        data-id="{{ $referral_service['referral_service_id'] }}"
                                                        data-evidence="{{ ReferralService::evidence_path_2 }}"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            @if (isset($referral_service['evidence_path_3']))
                                                <div class="actions_evidence d-flex my-4">
                                                    <a href="{{ asset('storage/' . $referral_service['evidence_path_3']) }}"
                                                        target="_blank" class="btn btn-info" role="button">
                                                        <i class="fas fa-eye"></i></a>
                                                    <button class="btn btn-danger delete_evidence_for_referral"
                                                        data-id="{{ $referral_service['referral_service_id'] }}"
                                                        data-evidence="{{ ReferralService::evidence_path_3 }}"
                                                        type="button"> <i class="fas fa-trash"></i></button>
                                                </div>
                                            @endif
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            @if (isset($referral_service['evidence_path_4']))
                                                <div class="actions_evidence d-flex my-4">
                                                    <a href="{{ asset('storage/' . $referral_service['evidence_path_4']) }}"
                                                        target="_blank" class="btn btn-info" role="button">
                                                        <i class="fas fa-eye"></i></a>
                                                    <button class="btn btn-danger delete_evidence_for_referral"
                                                        data-id="{{ $referral_service['referral_service_id'] }}"
                                                        data-evidence="{{ ReferralService::evidence_path_4 }}"
                                                        type="button"> <i class="fas fa-trash"></i></button>
                                                </div>
                                            @endif
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            @if (isset($referral_service['evidence_path_5']))
                                                <div class="actions_evidence d-flex my-4">
                                                    <a href="{{ asset('storage/' . $referral_service['evidence_path_5']) }}"
                                                        target="_blank" class="btn btn-info" role="button">
                                                        <i class="fas fa-eye"></i></a>
                                                    <button class="btn btn-danger delete_evidence_for_referral"
                                                        data-id="{{ $referral_service['referral_service_id'] }}"
                                                        data-evidence="{{ ReferralService::evidence_path_5 }}"
                                                        type="button"> <i class="fas fa-trash"></i></button>
                                                </div>
                                            @endif
                    ...
                    <div @class(['row', 'd-none', 'col-12','mt-3']) id="div_other_form">
                        {{-- <div class="col-lg-4" id="div_not_access_the_service_referred">
                                <div class="form-group">
                                    ...
                                    <select name="not_access_the_service_referred" class="selectpicker form-control"
                                        placeholder='Select choice...' id="not_access_the_service_referred">
                                        <option value="" hidden selected>---Select Reason---</option>
                                        @foreach ($REASON_FOR_NOT_ACCESSING as $key => $item)
                                            <option value="{{ $key }}">
                                                {{ $item }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                {{ Form::label('date_of_accessing_service', 'Date of accessing service', ['class' => 'form-control-label']) }}
                                {{ Form::date('date_of_accessing_service', null, ['class' => 'form-control']) }}
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4" id="div_type_of_test">
                            <div class="form-group">
                                ...
                                <select name="type_of_test" id="type_of_test" class="form-control">
                                    ...
                                    <option value="1" @selected(isset($referral_service) && 1 == $referral_service?->type_of_test)>Screening</option>
                                    <option value="2" @selected(isset($referral_service) && 2 == $referral_service?->type_of_test)>Confirmatory Test
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12">
                            <h3 id="div_center_title" @class(['d-none'])>If referred from a different service
                                center</h3>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                {{ Form::label('test_centre_state_id', 'Centre state', ['class' => 'form-control-label']) }}
                                {{ Form::select('test_centre_state_id', $states, null, ['class' => 'form-control', 'placeholder' => '--- Select State ---']) }}
                            </div>
                        </div>
                        {{-- </div> --}}
                        {{-- <div class="row"> --}}
                        <div class="col-lg-4">
                            <div class="form-group">
                                {{ Form::label('test_centre_district_id', 'Centre district', ['class' => 'form-control-label']) }}
                                {{ Form::select('test_centre_district_id', [], null, ['class' => 'form-control', 'placeholder' => '--- Select District ---', 'disabled' => true, 'data-id' => isset($referral_service) ? $referral_service?->test_centre_district_id : old('test_centre_district_id')]) }}
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                {{ Form::label('service_accessed_center_id', 'Name and address of centre', ['class' => 'form-control-label']) }}
                                {{ Form::select('service_accessed_center_id', [], null, ['class' => 'form-control', 'required' => true, 'disabled' => true, 'data-id' => isset($referral_service) ? $referral_service?->service_accessed_center_id : old('service_accessed_center_id ')]) }}
                            </div>
                        </div>
                        {{-- </div> --}}
                    ...
                    {{-- <div @class(['row', 'd-none']) id="div_center">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select name="treated_state_id" id="treated_state_id" class="form-control"
                                    data-id="{{ isset($appointment) ? $appointment?->treated_state_id : old('treated_state_id') }}"
                                    >
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                {{ Form::label('treated_district_id', 'Center district', ['class' => 'form-control-label']) }}
                                {{ Form::select('treated_district_id', [], null, ['class' => 'form-control', 'placeholder' => '--- Select District ---', 'disabled' => true, 'data-id' => isset($appointment) ? $appointment?->treated_district_id : old('treated_district_id')]) }}
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                {{ Form::label('treated_center_id', 'Name and address of Center', ['class' => 'form-control-label']) }}
                                {{ Form::select('treated_center_id', [], null, ['class' => 'form-control', 'placeholder' => '--- Select Center ---', 'disabled' => true, 'data-id' => isset($appointment) ? $appointment?->treated_center_id : old('treated_center_id')]) }}
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <div class="pl-lg-4">
                        <div @class([
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    {{ Form::label('pre_art_no', 'Pre ART No', ['class' => 'form-control-label']) }}
                                    {{ Form::text('pre_art_no', !empty($referral_service['pre_art_no']) ? $referral_service['pre_art_no'] : null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    {{ Form::label('on_art_no', 'On ART No', ['class' => 'form-control-label']) }}
                                    {{ Form::text('on_art_no', !empty($referral_service['on_art_no']) ? $referral_service['on_art_no'] : null, ['class' => 'form-control']) }}
                                </div>
                            </div>
                        </div>
                    </div>

                    <div @class(['row', 'd-none', 'col-12']) id="outcome_remark">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="outcome_of_the_service_sought" class="selectpicker form-control"
                                    ...
                                    @foreach ($OUTCOME as $key => $item)
                                        <option value="{{ $key }}" @selected((isset($referral_service) && $referral_service['outcome_of_the_service_sought'] == $key) || (empty($referral_service['outcome_of_the_service_sought']) && $loop->last))>
                                            {{-- {{ old('outcome_of_the_service_sought', 3) == $key ? 'selected' : '' }}> --}}
                                            {{ $item }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    {{-- -------------------Do you have Evidence section ends ------------------------ --}}
                    ...
                    {{-- <div class="pl-lg-4">
                        @if (isset($referral_service) && isset($canTakeAction) && $canTakeAction)
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
