							...
							<div class="row" id="topologySec" style="display:none">
							   ...
							   <div class="col-8">
                                   <select class="form-control" onChange="makechartReferredServices('topology',this.value)">
									 ...
									 @foreach($typologies as $topology)
									  @if ($topology->target_population == '')
										 <option value="">{{ "Blank" }}</option>
									  @else
										  <option value="{{$topology->target_population}}">{{$topology->target_population }}</option>
										@endif
...
function makechart(type)
	{
		...
		var DataJson =  {"_token": "{{ csrf_token() }}","type":type}
		$.ajax({
			url:"{{route('dashboard.mereport.chart')}}",
			method:"POST",
			data:DataJson,
			dataType:"JSON",
...
function DateBtnTotalRisk(){
	...
	var DataJson =  {"_token": "{{ csrf_token() }}","type":2,"to_date":to_date,"date_from":date_from}
		$.ajax({
			url:"{{route('dashboard.mereport.bar.chart')}}",
			method:"POST",
			data:DataJson,
			dataType:"JSON",
			success:function(data)
...
function makechartTotalRisk(type){
	...
	$("#date_range").hide();
	var DataJson =  {"_token": "{{ csrf_token() }}","type":type,"to_date":'',"date_from":''}
		$.ajax({
			url:"{{route('dashboard.mereport.bar.chart')}}",
			method:"POST",
			data:DataJson,
...
function makechartReferredServices(type,value=""){
	...
	var DataJson =  {"_token": "{{ csrf_token() }}","type":type,"value":value,"to_date":to_date,"date_from":date_from}
		$.ajax({
			url:"{{route('dashboard.mereport.service.chart')}}",
			method:"POST",
			data:DataJson,
			dataType:"JSON",
			success:function(data)
...
function makechartAvailedServices(type,value=""){
	...
	var DataJson =  {"_token": "{{ csrf_token() }}","type":type,"value":value,"to_date":to_date,"date_from":date_from}
		$.ajax({
			url:"{{route('dashboard.mereport.availed.chart')}}",
			method:"POST",
			data:DataJson,
			dataType:"JSON",
			success:function(data)
...
function makechartHIVPositive(type,value=""){
	...
	var DataJson =  {"_token": "{{ csrf_token() }}","type":type,"value":value,"to_date":to_date,"date_from":date_from}
    $.ajax({
		url:"{{route('dashboard.mereport.hivrate.chart')}}",
			method:"POST",
			data:DataJson,
			dataType:"JSON",
			success:function(data){
...
function makechartSTIPositive(type,value=""){
 ...
 var DataJson =  {"_token": "{{ csrf_token() }}","type":type,"value":value,"to_date":to_date,"date_from":date_from}
	...
	$.ajax({
		url:"{{route('dashboard.mereport.sti.chart')}}",
			method:"POST",
			data:DataJson,
			dataType:"JSON",
			success:function(data){
...
function makechartHIVReferral(type,value=""){
	...
	var DataJson =  {"_token": "{{ csrf_token() }}","type":type,"value":value,"to_date":to_date,"date_from":date_from}
    $.ajax({
		url:"{{route('dashboard.mereport.referral.chart')}}",
			method:"POST",
			data:DataJson,
			dataType:"JSON",
			success:function(data){
