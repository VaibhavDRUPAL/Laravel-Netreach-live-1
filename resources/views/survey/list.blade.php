                            ...
                            <table class="table table-hover align-items-center">
								...
								?>
									...
									<tr>
										...
										<td>
											@if($list->flag==0)  
											<button type="button" class="btn btn-sm btn-default"  id="survey_id_{{$list->survey_ids}}" onclick="return uploadReport({{$list->survey_ids}});" >Upload</button>
											@else
											{{'Uploaded'}}	
											@endif
										</td>
										...
										<td>
											@if($list->survey_co_flag==0)
												...
												<div id="div_con_btn_{{$list->survey_ids}}"><button type="button" class="btn btn-sm btn-info"  id="co_id_{{$list->survey_ids}}" onclick="return counseling({{$list->survey_ids}});" >Counseling</button></div> <!-- -->
												 @endcan
											@else
