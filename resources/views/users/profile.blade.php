                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    @if ($role)
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('role', $role, ['class' => 'form-control', 'disabled'=>true ]) }}
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-lg-6">
                                    @if ($centreName)
                                        <div class="form-group">
                                            {{ Form::label('Centre Name', 'Centre Name', ['class' => 'form-control-label']) }}
                                            {{ Form::text('Centre Name', $centreName, ['class' => 'form-control', 'disabled'=>true ]) }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::email('vn_email', $user->vn_email, ['class' => 'form-control']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::hidden('vms_details_ids', $user->vms_details_ids, ['class' => 'form-control']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
