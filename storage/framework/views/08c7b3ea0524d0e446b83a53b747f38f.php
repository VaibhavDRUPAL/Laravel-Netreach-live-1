                                ...
                                <?php if($data->isNotEmpty()): ?>
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td scope="row"><?php echo e($language[Language::label_as]); ?></td>
                                            <td scope="row"><?php echo e($language[Language::name]); ?></td>
                                            <td scope="row">
                                                <a href="#" class="px-1 edit-language"
                                                    data-id="<?php echo e($language[Language::language_id]); ?>">
                                                    <i class="fas text-primary fa-edit"></i>
                                                </a>
                                                <a href="#" class="px-1">
                                                    <i class="fas text-danger fa-trash delete-language"
                                                        data-id="<?php echo e($language[Language::language_id]); ?>"
                                                        data-label="<?php echo e($language[Language::label_as]); ?>"></i>
                                                </a>
                                            </td>
                                        </tr>
            ...
            <div class="modal-body p-0">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <form action="<?php echo e(route('language.save')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="label_as"
                                            value="<?php echo e(old('label_as')); ?>" id="label_as" placeholder="Bengali" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="language_code"
                                            value="<?php echo e(old('language_code')); ?>" id="language_code" placeholder="en-bn"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="locale"
                                            value="<?php echo e(old('locale')); ?>" id="locale" placeholder="bn" required>
                                    </div>
                                </div>
                            </div>
...
<script
    src="<?php echo e(App::isProduction() ? secure_asset('assets/js/custom/language.js') : asset('assets/js/custom/language.js')); ?>">
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/language/admin/index.blade.php ENDPATH**/ ?>