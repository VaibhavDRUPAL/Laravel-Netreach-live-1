                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('cms_title', $post->post_title, ['class' => 'form-control'])); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::textarea('cms_body', $post->post_body, ['id'=>"summernote", 'class'=> 'form-control',]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/post/edit.blade.php ENDPATH**/ ?>