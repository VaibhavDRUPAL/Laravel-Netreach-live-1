                        ...
                        <div>					    
							...
							<table class="table table-hover align-items-center" id="survy_data_tbl_id">
                                ...
                                <tr>									
                                    ...
                                    <th scope="col">Duration of Counselling* </th>
...
<script type="text/javascript" charset="utf8" src="<?php echo e(asset('assets/js/jquery.dataTables.min.js')); ?>"></script>
	...
	$(document).ready(function() {
        ...
        "ajax": {
            "url": "<?php echo e(route('all.counselling.services')); ?>",
            "type": "POST",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/manual1/counsellingservices.blade.php ENDPATH**/ ?>