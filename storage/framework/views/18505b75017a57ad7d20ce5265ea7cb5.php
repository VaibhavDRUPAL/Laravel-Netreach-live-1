            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="ab-mid-section">
                        <div class="container">
                            <?php echo e(Form::open(array('url' => '/services_required_submit'))); ?>
                            ...
                            <div class="col-12 col-md-8">
                                <button type="submit" class="btn btn-primary btn-lg mb-5" style="background-color:#00A79D;border-color:#00A79D;height:50px;text-transform: none;" value="" id="submit"><b>&nbsp;&nbsp;Lets Go </b><img src="<?php echo e(asset('assets/img/web/arrow.png')); ?>" style="width:40px;margin-left:10px"></button>
                            </div>
                ...
                <div class="col-md-5 text-right">
                    <img src="<?php echo e(asset('assets/img/web/services_required.png')); ?>">
                </div>
            </div>
            <!--row-->
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.apphome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/home/survey/services-required.blade.php ENDPATH**/ ?>