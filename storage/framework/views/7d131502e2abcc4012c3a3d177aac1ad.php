                            ...
                            <table class="table table-hover align-items-center">
								...
								?>
									...
									<tr>
										...
										<td>
											<?php if($list->flag==0): ?>  
											<button type="button" class="btn btn-block btn-default"  id="survey_id_<?php echo e($list->survey_ids); ?>" onclick="return uploadReport(<?php echo e($list->survey_ids); ?>);" >Upload</button>
											<?php else: ?>
											<?php echo e('Uploaded'); ?>	
											<?php endif; ?>
										</td>
										...
										<td>
											<?php if($list->survey_co_flag==0): ?>
												...
												<div id="div_con_btn_<?php echo e($list->survey_ids); ?>"><button type="button" class="btn btn-info"  id="co_id_<?php echo e($list->survey_ids); ?>" onclick="return counseling(<?php echo e($list->survey_ids); ?>);" >Counseling</button></div> <!-- -->
												 <?php endif; ?>
											<?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/survey/list_filter.blade.php ENDPATH**/ ?>