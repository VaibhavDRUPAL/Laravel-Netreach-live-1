                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('phone_number', null, ['class' => 'form-control', 'required'])); ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('role', $roles, null, ['class' => 'selectpicker form-control', 'placeholder' => 'Select role...', 'id' => 'role'])); ?>
                                ...
                                <div class="col-lg-6">
                                     <div class="form-group">
                                        ...
                                        <?php echo e(Form::textarea('bio', null, ['class' => 'form-control','rows'=>1])); ?>
                                ...
                                <div class="col-lg-6 test-fields" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('referred_state_id', $states, null, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select state...', 'required'=>true, 'id' => 'referred_state_id'])); ?>
                                ...
                                <div class="col-lg-6 test-fields" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('referred_district_id', [], null, [ 'class'=> 'form-control', 'placeholder' => 'Select choice...', 'required'=>true, 'disabled'=> true, 'id' => 'referred_district_id'])); ?>
                                ...
                                <div class="col-lg-6 test-fields" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('test_center_id', [], null, ['class' => 'form-control', 'required'=>true, 'disabled'=> true, 'id' => 'test_center_id'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/users/create.blade.php ENDPATH**/ ?>