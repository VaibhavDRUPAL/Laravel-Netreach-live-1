                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('role', $roles, $userRoleId, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select role...', 'id' => 'role'])); ?>

                                    </div>
                                </div>
                                <div class="col-lg-6">
                                     <div class="form-group">
                                        <?php echo e(Form::label('bio', 'Bio', ['class' => 'form-control-label'])); ?>

                                        <?php echo e(Form::textarea('bio', $user->bio, ['class' => 'form-control','rows'=>1])); ?>

                                    </div>
                                </div>
                                <div class="col-lg-6 test-fields" style="display: none;">
                                    <div class="form-group">
                                        <?php echo e(Form::label('center_state_id', 'Referred centre state', ['class' => 'form-control-label'])); ?>

                                        <?php echo e(Form::select('center_state_id', $states,  $centerState, [ 'class'=> 'selectpicker form-control', 'placeholder' => 'Select state...', 'id' => 'center_state_id'])); ?>

                                    </div>
                                </div>
                                <div class="col-lg-6 test-fields" style="display: none;">
                                    <div class="form-group">
                                        <?php echo e(Form::label('center_district_id', 'Referred centre district', ['class' => 'form-control-label'])); ?>

                                        <?php echo e(Form::select('center_district_id', $districts, $centre->district_id, [ 'class'=> 'form-control', 'placeholder' => 'Select district...', 'id' => 'center_district_id'])); ?>

                                    </div>
                                </div>
                                <div class="col-lg-6 test-fields" style="display: none;">
                                    <div class="form-group">
                                        <?php echo e(Form::label('test_center_id', 'Name and address of centre', ['class' => 'form-control-label'])); ?>

                                        <?php echo e(Form::select('test_center_id',$centers , $centre->id, ['class' => 'form-control', 'placeholder' => 'Select centre...' , 'id' => 'test_center_id'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/users/edit.blade.php ENDPATH**/ ?>