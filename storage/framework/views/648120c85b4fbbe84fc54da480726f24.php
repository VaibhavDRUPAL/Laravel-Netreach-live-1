...
<section class="landing-sec-1 landing-page7-sec-1">
  ...
  <div class="banner-caption">
    <div class="container">
      <!-- <?php echo e(Form::open(array('url' => '/user-register'))); ?> -->
      <div class="row mt-4">
        ...
        <div class="col-md-4 col-xs-12 clientPage">
          ...
          <div class="banerform border-0 shadow-none">
            ...
            <a href="javascript:void(0);" id="submit" style="background-color:#00A79D;border-color:#00A79D" class="btn btn-primary btn-lg mb-5">
              <h4 style="display: inline;"><b>Lets Go </b>&nbsp; <img src="<?php echo e(asset('assets/img/web/arrow.png')); ?>" style="width:40px"> </h4>
            </a>
        ...
        <div class="col-md-6 col-xs-12 text-right">
          <img src="<?php echo e(asset('assets/img/web/client_info.png')); ?>">
        </div>
      </div>
      <!--row-->
...
<script>
  $(document).ready(function() {
    ...
    $('#submit').click(function() {
      ...
      if (hiv.validate(mesg)) {
        ...
        var email = $("#email").val();
        $.ajax({
          url: '<?php echo e(route("varify-otp")); ?>',
          type: 'POST',
          dataType: "json",
          data: {
    ...
    $("#otpSubmit").click(function() {
      ...
      if (otp == '') {
        ...
        $.ajax({
          url: '<?php echo e(route("user_register")); ?>',
          type: 'POST',
          dataType: "json",
          data: {
            "_token": "<?php echo e(csrf_token()); ?>",
          ...
          success: function(otpResult) {
            ...
            if (otpResult.statusCode == 200) {
              ...
              window.location.href = "<?php echo e(route('services-required')); ?>";
  ...
  function getExistClientInfo(type) {
    ...
    if (ph != '') {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo e(route('usr.exist')); ?>",
        dataType: "json",
        data: {
          "_token": "<?php echo e(csrf_token()); ?>",
          "type": type,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.apphome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/home/survey/client-inform.blade.php ENDPATH**/ ?>