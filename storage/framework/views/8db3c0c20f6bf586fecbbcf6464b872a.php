        ...
        <div class="col-md-12">
            <div class="card mb-5 px-4 pt-3">
                <div id="filter-form-container" style="display: none;">
                    <form action="<?php echo e(route('admin.self-risk-assessment.combine')); ?>" method="post" id="frm-combine-sra">
                        <div class="form-row">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/self/admin/combine-list.blade.php ENDPATH**/ ?>