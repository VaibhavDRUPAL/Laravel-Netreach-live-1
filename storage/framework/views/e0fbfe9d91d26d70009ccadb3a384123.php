            ...
            <div class="header-body text-center mb-9">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 image-bg-content ">
                        <a href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(asset('assets/img/web/logo.png')); ?>"></a>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 image-bg-content">
                        <a href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(asset('assets/img/web/humsafar-logo.png')); ?>"
                                style="width: 125px"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 col-md-8">
                <div class="card bg-secondary border border-soft">
                    ...
                    <div class="card-body px-lg-5 py-lg-3 pt-2">
                        <form method="POST" action="<?php echo e(route('login')); ?>" id="frm-login">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="g-recaptcha mb-4" data-sitekey="<?php echo e(env('G_SITE_KEY')); ?>" data-callback="enableBtn">
                            </div>
                            ...
                            <div class="custom-control custom-control-alternative custom-checkbox">
                                <input class="custom-control-input" id=" customCheckLogin" name="remember"
                                    <?php echo e(old('remember') ? 'checked' : ''); ?> type="checkbox">
    ...
    <script>
        ...
        // // Get FCM token
        // messaging.getToken({
        //     vapidKey: "<?php echo e(env('FIREBASE_VAPID_KEY')); ?>"
        // }).then((token) => {
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/auth/login.blade.php ENDPATH**/ ?>