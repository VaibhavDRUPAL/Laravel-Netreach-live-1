			...
			<div class="table-responsive">
				<div class="header-div">				    
					...
					<select name="state_outreach" id="state_outreach"  >
						...
						<option value="<?php echo e($val->state_code); ?>"><?php echo e($val->state_name); ?></option>	
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
					</select>
					
					<select name="virtual_outreach" id="virtual_outreach"  >
						<option value="">--VN/CO--</option>
						<?php $__currentLoopData = $rslt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			<div class="table-responsive">
				<div class="header-div">				    
					...
					<select name="hp_states" id="hp_states"  >
						<option value="">--Select--</option>
						<?php $__currentLoopData = $state_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/manual1/dashboard.blade.php ENDPATH**/ ?>