<?php $__env->startPush('styles'); ?>
            ...
            function refreshTable(search = '') {
                $(document).ready(function() {
                    var dataTableObj = $('#survy_data_tbl_id').dataTable({
                        ...
                        "ajax": {
                            "url": "<?php echo e(route('outreach.sti.list')); ?>",
                            "type": "POST",
                            "data":  {
    ...
    <?php $__env->stopPush(); ?>
<?php $__env->stopPush(); ?>.
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/outreach/sti/index.blade.php ENDPATH**/ ?>