			...
			<div class="table-responsive">
				<div class="header-div">
					<select name="target_pop" id="target_pop">
						...
						<?php $__currentLoopData = $typology_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->target_id); ?>"><?php echo e($val->target_type); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>

					<select name="region_outreach" id="region_outreach">
						<option value="">--Region --</option>
							<?php $__currentLoopData = $region; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<select name="state_outreach" id="state_outreach">
						...
						<?php $__currentLoopData = $state_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<select name="virtual_outreach" id="virtual_outreach">
						...
						<?php $__currentLoopData = $vn_co; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->vns); ?>"><?php echo e($val->vns); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;
					</select>
					<br />
			...
			<div class="table-responsive">
				<div class="header-div">
					...
					<select name="risk_category" id="risk_category">
						...
						<?php $__currentLoopData = $risk_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($key); ?>"><?php echo e($val); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
					...
					<select name="app_risk" id="app_risk">
						...
						<?php $__currentLoopData = $platforms_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="table-responsive">
            <div class="header-div">
                ...
                <select name="health_facility " id="health_facility">
                    ...
                    <?php $__currentLoopData = $type_of_facility; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option value="<?php echo e($key); ?>"><?php echo e($val); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <select name="type_test" id="referred_type_test">
                    ...
                    <?php $__currentLoopData = $type_of_test; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($key); ?>"><?php echo e($val); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <select name="client_type" id="referred_client_type">
                    <option value="">--Client type--</option>
                     <?php $__currentLoopData = $client_type_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->client_type_id); ?>"><?php echo e($val->client_type); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <select name="service_referral" id="service_referral">
                    ...
                    <?php $__currentLoopData = $type_of_service_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->service_type_id); ?>"><?php echo e($val->service_type); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script type="text/javascript">
	$(document).ready(function() {
		var options = {
		 ...
		 $.getJSON("<?php echo e(route('outreach.manually.datapiechart')); ?>", function(json) {
		 	console.log(json);
		     options.series = json;
		...
		$("#btn_outreach").click(function() {
			...
			$.getJSON("<?php echo e(route('outreach.manually.datapiechart')); ?>", myObject, function(json) {
				console.log(json);
		...
		$.getJSON("<?php echo e(route('outreach.manually.datapiechartrisk')); ?>", function(json) {
		console.log(json);					
		...
		$("#btn_risk_assignment").click(function() {
			...
			$.getJSON("<?php echo e(route('outreach.manually.datapiechartrisk')); ?>", myObject, function(json) {
				//console.log(json);					
				Risk.xAxis.categories = json[0]['data']; //xAxis: {categories: []}
				Risk.series[0] = json[1];
				chart = new Highcharts.Chart(Risk);
		...
		$.getJSON("<?php echo e(route('outreach.manually.datapiechartreferred')); ?>", function(json) {
		// 	//console.log(json);					
		...
		$("#btn_referred").click(function() {
			...
			$.getJSON("<?php echo e(route('outreach.manually.datapiechartreferred')); ?>", myObject, function(json) {
				//console.log(json);					
				Referred.xAxis.categories = json[0]['data']; //xAxis: {categories: []}
				Referred.series[0] = json[1];
				chart = new Highcharts.Chart(Referred);
    ...
    $.getJSON("<?php echo e(route('outreach.manually.datapiechartreferred')); ?>", function(json) {
		...
		$.getJSON("<?php echo e(route('outreach.manually.datapiechartavailedservices')); ?>", function(json) {
		// 	//console.log(json);					
		...
		$("#btn_as").click(function() {
			...
			$.getJSON("<?php echo e(route('outreach.manually.datapiechartavailedservices')); ?>", myObject, function(json) {
				//console.log(json);					
				availedservices.xAxis.categories = json[0]['data']; //xAxis: {categories: []}
				availedservices.series[0] = json[1];
				chart = new Highcharts.Chart(availedservices);
		...
		$.getJSON("<?php echo e(route('outreach.manually.hivpositivity')); ?>", function(json) {
		...
		$("#btn_hp").click(function() {
			...
			$.getJSON("<?php echo e(route('outreach.manually.hivpositivity')); ?>", myObject, function(json) {
				hiv_positivity_bar.xAxis.categories = json[0]['data'];
				hiv_positivity_bar.series[0] = json[1];
				chart = new Highcharts.Chart(hiv_positivity_bar);
			});
		...
		$.getJSON("<?php echo e(route('outreach.manually.hiv.referralconversion.rate')); ?>", function(json) {
		...
		$("#btn_cr").click(function() {
			...
			$.getJSON("<?php echo e(route('outreach.manually.hiv.referralconversion.rate')); ?>", myObject, function(json) {
				//console.log(json);					
				hiv_referral_conversion_rate.xAxis.categories = json[0]['data']; //xAxis: {categories: []}
				hiv_referral_conversion_rate.series[0] = json[1];
				chart = new Highcharts.Chart(hiv_referral_conversion_rate);;
		...
		$.getJSON("<?php echo e(route('outreach.manually.hiv.sti.positivity')); ?>", function(json) {
		...
		$("#btn_sti").click(function() {
			...
			$.getJSON("<?php echo e(route('outreach.manually.hiv.sti.positivity')); ?>", myObject, function(json) {
				//console.log(json);					
				sti_positivity.xAxis.categories = json[0]['data']; //xAxis: {categories: []}
				sti_positivity.series[0] = json[1];
				chart = new Highcharts.Chart(sti_positivity);
		...
		var art_linked = {
		 ...
		 $.getJSON("<?php echo e(route('outreach.manually.hiv.art.positivity')); ?>", function(json) {
			//console.log(json);					
		...
		$("#btn_art").click(function() {
			...
			$.getJSON("<?php echo e(route('outreach.manually.hiv.art.positivity')); ?>", myObject, function(json) {
				//console.log(json);					
				art_linked.xAxis.categories = json[0]['data']; //xAxis: {categories: []}
				art_linked.series[0] = json[1];
				chart = new Highcharts.Chart(art_linked);
...
<script>
	function getIndicate(){
		...
		var myObject = {indi:123,indi_date_frm:indi_date_frm,indi_date_to:indi_date_to};
			 $.getJSON("<?php echo e(route('outreach.manually.hiv.art.indicators')); ?>",myObject, function(json){
					console.log(json);
	...
	function getIndicators(){
		...
		var indi_date_to = $("#indi_date_to").val();
		var myObject = {indi:123,indi_date_frm:indi_date_frm,indi_date_to:indi_date_to};
			 $.getJSON("<?php echo e(route('outreach.manually.hiv.art.client.indicators')); ?>",myObject, function(json) {
					console.log(json);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/manual/dashboard.blade.php ENDPATH**/ ?>