...
<head>
    ...
    <meta name="og:image" content="<?php echo e(asset('assets/img/web/logo-bac.png')); ?>">
    ...
    <?php echo $__env->yieldPushContent('meta_data'); ?>

    <title><?php echo e(config('app.name', 'Laravel')); ?></title>
    <link rel="stylesheet" media="all" href="<?php echo e(asset('assets/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" media="all" href="<?php echo e(asset('assets/css/all.min.css')); ?>">
    <link rel="stylesheet" media="all" href="<?php echo e(asset('assets/css/style.css')); ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"
        integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet"
        href="<?php echo e(App::isProduction() ? secure_asset('assets/css/chatbot.css') : asset('assets/css/chatbot.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(App::isProduction() ? secure_asset('assets/css/custom.css') : asset('assets/css/custom.css')); ?>">
    ...
    <style>
        ...
        .btn_letsgo {
            ...
            background-image: url("<?php echo e(asset('assets/img/web/letsgo.png')); ?>") !important;
        ...
        .btn_next {
            ...
            background-image: url("<?php echo e(asset('assets/img/web/right_arrow.png')); ?>") !important;
            background-repeat: no-repeat;
            border: none;
        ...
        .btn_back {
            ...
            /*    background-image: url("<?php echo e(asset('assets/img/web/left_arrow.png')); ?>") !important;*/
...
<body>
    ...
    <?php endif; ?>
    <?php echo $__env->make('includes.chatbot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div id="fb-root"></div>
        ...
        <div class="container-fluid">
            <div class="row align-items-center" style="padding-top: 10px;">
                <div class="col-md-2 d-flex  logo" id="nav-bar-logo-web">
                    <a class="mr-3" href="<?php echo e(URL::to('https://humsafar.org/')); ?>"><img
                ...
                <div class="col-md-8 mt-3 navigation">
                    ...
                    <div class="main-nav" id="opennav">
                        ...
                        <ul>
                            ...
                            <li><a
                                    href="<?php echo e(URL::to($lang !== 'en' ? '/' . $lang : '/')); ?>"><?php echo e(__('navbar.home')); ?></a>
                            </li>
                            <li><a
                                    href="<?php echo e(URL::to($lang !== 'en' ? '/' . $lang . '/about-us' : '/about-us')); ?>"><?php echo e(__('navbar.about')); ?></a>
                            </li>
                            <li><a
                                    href="<?php echo e(URL::to($lang !== 'en' ? '/' . $lang . '/faqs' : '/faqs')); ?>"><?php echo e(__('navbar.faqs')); ?></a>
                            </li>
                            <li><a
                                    href="<?php echo e(URL::to($lang !== 'en' ? '/' . $lang . '/sra' : '/sra')); ?>"><?php echo e(__('navbar.risk')); ?></a>
                            </li>
                            <li><a
                                    href="<?php echo e(URL::to($lang !== 'en' ? '/' . $lang . '/contact-us' : '/contact-us')); ?>"><?php echo e(__('navbar.contact')); ?></a>
                            </li>
                            <li><a
                                    href="<?php echo e(URL::to($lang !== 'en' ? '/' . $lang . '/our-team' : '/our-team')); ?>"><?php echo e(__('navbar.team')); ?></a>
                            </li>
                            <li><a
                                    href="<?php echo e(URL::to($lang !== 'en' ? '/' . $lang . '/blog' : '/blog')); ?>"><?php echo e(__('navbar.blog')); ?></a>
                            </li>
                ...
                <div class="col-md-2">
                    <a href="<?php echo e(URL::to('/')); ?>" target="_blank">
                        <img class="ml-3" id="netreach-logo" src="<?php echo e(asset('assets/img/web/logo-bac.png')); ?>"
                            style="width:80%"></a>
                </div>
                <!--humsafar-logo-->
            </div>
            ...
            <div class="row mb-4 mr-md-4">
                <div class="footer-dial">
                    ...
                    <a href="tel:1097" target="_blank" style="display: none;"><img
                            src="<?php echo e(asset('assets/img/web/Counsellor_Hotline_button.png')); ?>"
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <a href="tel:1097" class="mr-3" target="_blank"><img
                                    src="<?php echo e(asset('assets/img/web/NACO_helpline.png')); ?>" style="width: 60px;"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid d-block" style="background-color:#F2FBFF;">
            <div class="row">
                <div class="col-6 d-flex justify-content-start">
                    <img src="<?php echo e(asset('assets/img/web/humsafar-logo.png')); ?>" class="img-fluid"
                        style="height:50px" />
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <img src="<?php echo e(asset('assets/img/web/alliance-india.png')); ?>" class="img-fluid"
                        style="height:50px" />
                </div>
            </div>

            <div class="p-2 footerDisclaimer">
                <strong> <?php echo e(__('navbar.disclaimer1')); ?></strong><?php echo e(__('navbar.disclaimer2')); ?>
        ...
        <div class="container-fluid d-block" style="background-color:#1476A1;">
            <div class="p-2 px-5 text-white footerDisclaimer">
                <a href="javascript:void(0);" data-toggle="modal" data-target="#terms_of_use" title="Teams of Use"
                    ...
                    <?php echo e(__('navbar.terms')); ?>

                </a> |
                
                <a href="<?php echo e(url(session('locale', 'en') == 'en' ? 'privacy-policy' : session('locale') . '/privacy-policy')); ?>" target="_self" title="Privacy Policy - NETREACH Web Portal"
                    class="text-white" style="text-decoration: none">
                    <?php echo e(__('navbar.policy')); ?>

                </a> |
                <a href="javascript:void(0);" data-toggle="modal" data-target="#copyright" title="Copyright Policy"
                    class="text-white" style="text-decoration: none">
                    <?php echo e(__('navbar.copyright')); ?>
    ...
    <div class="modal fade" id="terms_of_use" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('navbar.terms')); ?> </h5>
                </div>
                <div class="modal-body text-secondary">
                    <p>
                        <?php echo e(__('navbar.terms_text')); ?>

                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary mx-auto" data-dismiss="modal"><?php echo e(__('navbar.Close')); ?> </button>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /var/www/netreach2/resources/views/layouts/apphome.blade.php ENDPATH**/ ?>