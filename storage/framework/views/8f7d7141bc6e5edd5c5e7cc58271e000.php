    ...
    <?php $__env->startSection('content'); ?>
        <div class="row">
            <div class="col-md-12 my-2">
                <a href="<?php echo e(route('outreach.plhiv.list.export')); ?>" class="btn btn-primary  w-2 m-2 text-white"
            ...
            <div class="col-md-12">
                <div class="card mb-5">
                    <div class="card-header bg-transparent">
                        <div class="row">
                            <div class="col-lg-4">
                                <h3 class="mb-0">All PLHIV Tests</h3>
                                
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group mb-0">
                                    <?php echo e(Form::text('search', request()->query('search'), ['class' => 'form-control form-control-sm', 'placeholder' => 'Search by Referral Id', 'id' => 'search'])); ?>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo e(url('/Importplhiv')); ?>" enctype="multipart/form-data"> <?php echo csrf_field(); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            function refreshTable(search = '') {
                ...
                $(document).ready(function() {
                    ...
                    var dataTableObj = $('#survy_data_tbl_id').dataTable({
                        ...
                        "ajax": {
                            "url": "<?php echo e(route('outreach.plhiv.list')); ?>",
                            "type": "POST",
                            "data": {
            ...
            $(document).on('click', '#accept, #reject', function() {
                ...
                $.ajax({
                    url: '/outreach/plhiv/take-action',
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/outreach/plhiv/index.blade.php ENDPATH**/ ?>