...
<div class="row">
    <div class="col-md-8">
        <div class="card mb-5">
            <div class="card-body">
                <?php echo Form::open(['route' => 'blog_categories_store']); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('blog_category_name', null, ['class' => 'form-control'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/blogCategories/createBlogCategories.blade.php ENDPATH**/ ?>