    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo e(asset('assets/img/web/slider2.jpg')); ?>">
      ...
      <a class="carousel-control-prev" href="#myCarousel" data-slide="prev">
        <img src="<?php echo e(asset('assets/img/web/slider-arrow.png')); ?>">
      </a>
...
<section class="consent" id="consent">
  <img src="<?php echo e(asset('assets/img/web/bg-image.jpg')); ?>">
...
<?php echo $__env->make('layouts.apphome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/home/index.blade.php ENDPATH**/ ?>