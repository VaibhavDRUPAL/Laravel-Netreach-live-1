            ...
            <div class="card mb-5">
                <div class="card-header bg-transparent">
                    <div class="row">
                        ...
                        <?php if(!Auth::user()->hasRole('VN User Permission')): ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var dataTableObj = $('#survy_data_tbl_id').dataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('all.survey.report.slip')); ?>",
                    "type": "POST",
                    "data": function(d) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/survey/list_slip.blade.php ENDPATH**/ ?>