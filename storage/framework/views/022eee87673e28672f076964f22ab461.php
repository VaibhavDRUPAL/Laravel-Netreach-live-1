<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-body">
                    <?php echo Form::open(['route' => ['profile.update', $user], 'files' => true]); ?>
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <?php if($role): ?>
                                        <div class="form-group">
                                            <?php echo e(Form::label('role', 'Role', ['class' => 'form-control-label'])); ?>

                                            <?php echo e(Form::text('role', $role, ['class' => 'form-control', 'disabled'=>true ])); ?>
                                ...
                                <div class="col-lg-6">
                                    <?php if($centreName): ?>
                                        <div class="form-group">
                                            <?php echo e(Form::label('Centre Name', 'Centre Name', ['class' => 'form-control-label'])); ?>

                                            <?php echo e(Form::text('Centre Name', $centreName, ['class' => 'form-control', 'disabled'=>true ])); ?>
							...
							<div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(strtoupper($user->email)); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::email('vn_email', $user->vn_email, ['class' => 'form-control'])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::hidden('email', $user->email, ['class' => 'form-control'])); ?>

                                        <?php echo e(Form::hidden('vms_details_ids', $user->vms_details_ids, ['class' => 'form-control'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/users/profile.blade.php ENDPATH**/ ?>