                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('title', $blog->title, ['class' => 'form-control'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::Label('blog_category_id', 'Blog Category', ['class' => 'form-control-label'])); ?>

                                <?php echo e(Form::select('blog_category_id', $blog_categories, $blog->blog_category_id, [ 'class'=> 'selectpicker form-control', 'placeholder'
                            ...
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('description', $blog->description, ['class' => 'form-control','rows'=> 15])); ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <?php echo e(Form::label('youtube_video_embed', 'Youtube Video Embed', ['class' =>
                                'form-control-label'])); ?>

                                <?php echo e(Form::textarea('youtube_video_embed', $blog->youtube_video_embed, ['class' => 'form-control','rows'=>7])); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('tags', $blog->tags, ['class' => 'form-control','rows'=>3])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('meta_title', $blog->meta_title, ['class' => 'form-control'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('meta_keywords', 'Meta Keywords', ['class' => 'form-control-label'])); ?>

                                <?php echo e(Form::text('meta_keywords', $blog->meta_keywords, ['class' => 'form-control'])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo e(Form::label('meta_description', 'Meta Description', ['class' =>
                                'form-control-label'])); ?>

                                <?php echo e(Form::textarea('meta_description', $blog->meta_description, ['class' => 'form-control','rows'=>6])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('author_name', $blog->author_name, ['class' => 'form-control'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('author_details', 'Author details', ['class' => 'form-control-label'])); ?>

                                <?php echo e(Form::textarea('author_details', $blog->author_details, ['class' => 'form-control','rows'=>6])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('facebook', $blog->facebook, ['class' => 'form-control'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('whatsapp', 'Whatsapp number', ['class' => 'form-control-label'])); ?>

                                <?php echo e(Form::text('whatsapp', $blog->whatsapp, ['class' => 'form-control'])); ?>

                            </div>
                            <div class="form-group">
                                <?php echo e(Form::label('instagram', 'Instagram link', ['class' => 'form-control-label'])); ?>

                                <?php echo e(Form::text('instagram', $blog->instagram, ['class' => 'form-control'])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="status" value="1" class="custom-control-input" id="status" <input type="checkbox" name="status" <?php if($blog->status): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/blogs/editBlog.blade.php ENDPATH**/ ?>