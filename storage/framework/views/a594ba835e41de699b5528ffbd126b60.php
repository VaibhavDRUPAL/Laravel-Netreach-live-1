                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-3">
                        	<div>
								...
								<?php echo e(Form::open(array('url' => '/survey/filter',"id"=>"another-element"))); ?>
                            ...
                            <table class="table table-hover align-items-center">
								...
								?>
									...
									<tr>
										...
										<td>
											<?php if($list->flag==0): ?>  
											<button type="button" class="btn btn-sm btn-default"  id="survey_id_<?php echo e($list->survey_ids); ?>" onclick="return uploadReport(<?php echo e($list->survey_ids); ?>);" >Upload</button>
											<?php else: ?>
											<?php echo e('Uploaded'); ?>	
											<?php endif; ?>
										</td>
										 <?php endif; ?>
										<td>
											<?php if($list->survey_co_flag==0): ?>
												<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('appoin-to-counseling')): ?>	
												<div id="div_con_btn_<?php echo e($list->survey_ids); ?>"><button type="button" class="btn btn-sm btn-info"  id="co_id_<?php echo e($list->survey_ids); ?>" onclick="return counseling(<?php echo e($list->survey_ids); ?>);" >Counseling</button></div> <!-- -->
												 <?php endif; ?>
											<?php else: ?>
										...
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('po-apporve-reject-action')): ?>	
										<td>
											<?php if($list->po_status==0): ?>
											<div id="div_po_btn_<?php echo e($list->survey_ids); ?>">											
												<a href="javascript:void(0);" id="po_id_<?php echo e($list->survey_ids); ?>" onclick="return po_action(<?php echo e($list->survey_ids); ?>);" class="btn btn-sm btn-info  mr-4 ">PO Action</a>
											</div> <!-- -->
											<?php else: ?>
...
function ajax_counseling(sid){
	...
	$.ajax({
		...
		data: {"_token": "<?php echo e(csrf_token()); ?>","sid": sid},
		dataType:"json",
...
$('#multi-file-upload').submit(function(e) {
	...
	let images = $('#files')[0];
	let dontshare=$('#dontshare_id').val();
...
$('#inputStateget').change(function(){
	...
	var jsonData = {"_token": "<?php echo e(csrf_token()); ?>","state_code": state_code}
		$.ajax({
			type:'POST',
...
function getRegion(id){
	...
	var jsonData = {"_token": "<?php echo e(csrf_token()); ?>","city_id": id}
		$.ajax({
			type:'POST',
                                               ...
                                               <form id="multi-file-upload" method="POST"  action="javascript:void(0)" accept-charset="utf-8" enctype="multipart/form-data">
												<?php echo csrf_field(); ?>
													...
													<div class="custom-control custom-checkbox">
														<input type="checkbox" id="dontshare_id" name="dontshare"
															class="custom-control-input" value="1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/survey/list.blade.php ENDPATH**/ ?>