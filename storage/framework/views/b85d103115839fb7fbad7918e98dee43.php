    ...
    <?php $__env->startSection('content'); ?>
        <div class="row">
            <div class="col-md-12 my-2">
                <a href="<?php echo e(route('outreach.referral-service.list.export')); ?>" class="btn btn-primary  w-2 m-2 text-white"
            ...
            function refreshTable(search = '') {
                ...
                $(document).ready(function() {
                    ...
                    var dataTableObj = $('#survy_data_tbl_id').dataTable({
                        ...
                        "ajax": {
                            "url": "<?php echo e(route('outreach.referral-service.list')); ?>",
                            "type": "POST",
                            "data": {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/outreach/referral-service/index.blade.php ENDPATH**/ ?>