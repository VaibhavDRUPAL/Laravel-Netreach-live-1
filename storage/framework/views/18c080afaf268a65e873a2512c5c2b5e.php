                ...
                <li class="nav-item dropdown">
                  ...
                  <span class="avatar avatar-sm rounded-circle">
                    <?php if(Auth::user()->profile_photo): ?>
                        <img width="45" height="45" class="img-fluid rounded-pill" src="<?php echo e(asset(Auth::user()->profile_photo)); ?>" alt="">
                    <?php else: ?>
...
<?php /**PATH /var/www/netreach2/resources/views/includes/header.blade.php ENDPATH**/ ?>