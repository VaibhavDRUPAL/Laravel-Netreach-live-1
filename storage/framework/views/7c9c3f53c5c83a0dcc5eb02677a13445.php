                                ...
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="<?php echo e($key); ?>"
                                                name="state[]" value="<?php echo e($key); ?>"
                                                <?php echo e(in_array($key, $stateArr) ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="<?php echo e($key); ?>"><?php echo e($val); ?></label>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/netreach2/resources/views/users/edit_vms.blade.php ENDPATH**/ ?>